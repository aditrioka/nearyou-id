...
actual class SecureTokenStore : TokenStore {
    ...
    private fun writeKeychainItem(value: String) {
        ...
        if (status != errSecSuccess) {
            ...
            // Surface the OSStatus only — NEVER token material. Duplicate-item can't
            // occur (delete-then-add above); other statuses (interaction-not-allowed,
            // IO) are environmental and visible in the device console via this line.
