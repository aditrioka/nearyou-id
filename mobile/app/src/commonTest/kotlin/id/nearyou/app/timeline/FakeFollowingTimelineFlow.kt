...
/**
 * Test-only [FollowingTimelineFlow] for screen tests (mirrors `FakeGlobalTimelineFlow`). Returns a
 * pre-programmed [FollowingTimelineOutcome] and counts invocations so a test can assert pull-to-refresh /
 ...
 */
class FakeFollowingTimelineFlow(
    private val outcome: FollowingTimelineOutcome = FollowingTimelineOutcome.Loaded(emptyList(), null, null),
...
/** Shared fixture: a fully-populated Following post (incl. PII fields, no distance) for projection / parsing / render tests. */
fun fakeFollowingPost(
    id: String = "p1",
    authorUserId: String = "11111111-1111-1111-1111-111111111111",
    authorUsername: String = "fajar.r",
    authorDisplayName: String = "Fajar Ramadhan",
    content: String = "Halo dari yang kamu ikuti",
