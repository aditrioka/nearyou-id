...
- [ ] 7.1 `POST /internal/data-export-worker` — OIDC-verified per `internal-endpoint-auth` (`GoogleOidcTokenVerifier`); scan `data_export_requests_pending_idx`, claim optimistically, process each.
