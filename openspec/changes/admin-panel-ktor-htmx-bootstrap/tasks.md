...
- [ ] 7.3 Verify [`openspec/project.md`](../../project.md) § Module Structure does NOT need updating — this change does NOT scaffold a new Gradle module (per `design.md` Decision 3 + Non-Goals). If something unexpected has changed during implementation, update the section.
