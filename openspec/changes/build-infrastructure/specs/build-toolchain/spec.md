...
- **THEN** the `[versions]` table contains pinned entries for `kotlin`, `ktor`, `kotlinx-coroutines`, `kotlinx-serialization`, `kotlinx-datetime`, `koin`, `flyway`, `hikaricp`, `kotest`, `ktlint`
