...
- **THEN** the helper resolves to the GCP Secret Manager slot named `staging-firebase-admin-sa` (per the namespace convention recorded in [`docs/08-Roadmap-Risk.md`](../../../docs/08-Roadmap-Risk.md))
