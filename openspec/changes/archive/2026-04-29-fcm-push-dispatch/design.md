...
- Rate-limiting FCM dispatch. FCM free-tier supports millions/day per [`docs/04-Architecture.md`](../../../docs/04-Architecture.md); a per-user dispatch cap is unwarranted at MVP scale.
