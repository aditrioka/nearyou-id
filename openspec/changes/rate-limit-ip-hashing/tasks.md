...
- [x] 1.4 Run `./gradlew :infra:otel:test :infra:redis:test` and confirm 8 new `IpHasherTest` scenarios + the new `LettuceSpanCaptureTest` pass alongside the 4 existing `UserIdHasherTest` scenarios.
