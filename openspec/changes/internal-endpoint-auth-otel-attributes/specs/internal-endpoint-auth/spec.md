...
- **GIVEN** an OTel pipeline configured with the `FailingSpanProcessor` test fixture from [`infra/otel/.../SpanRecorder.kt`](../../../infra/otel/src/testFixtures/kotlin/id/nearyou/app/infra/otel/SpanRecorder.kt) (the same fixture used by the `fcm-push-dispatch` "Span recording failure does not block dispatch" scenario) AND a successful `InternalEndpointAuth` request
