...
- **THEN** every match resides under one of the carved-out paths declared above (`auth/**`, `network/**`, `screens/auth/**`, `screens/routing/**`, `config/**` in any source set); no match resides outside those paths
