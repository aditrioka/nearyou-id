...
- **NEW** Repo-committed fallback files seeded with a starter wordlist (AI-generated + manual-review pass; ~50 profanity entries + ~30 UU ITE category entries — provisional seed, expanded in operations).
